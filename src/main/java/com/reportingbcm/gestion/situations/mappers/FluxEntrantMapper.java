...
public class FluxEntrantMapper {
    public static FluxEntrantDto toFluxEntrantsDto(final FluxEntrants f) {
        FluxEntrantDto fluxEntrantDto = FluxEntrantDto.builder()
